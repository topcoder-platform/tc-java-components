...
public class TestConfigurationFileManagerAccuracy extends TestCase {
    ...
    public void testConfigurationFileManagerString_1() throws Exception {
        manager = new ConfigurationFileManager("src/test/resources/test_files/accuracy/test1.xml");
        assertNotNull("Should not be null.", manager);
    ...
    public void testConfigurationFileManagerString_2() throws Exception {
        manager = new ConfigurationFileManager("src/test/resources/test_files/accuracy/manager1.properties");
        assertNotNull("Should not be null.", manager);
    ...
    public void testConfigurationFileManagerStringMap_1() throws Exception {
        ...
        manager = new ConfigurationFileManager("src/test/resources/test_files/accuracy/manager1.properties", p);
    ...
    public void testConfigurationFileManagerStringMap_2() throws Exception {
        ...
        manager = new ConfigurationFileManager("src/test/resources/test_files/accuracy/manager_empty.properties", p);
    ...
    public void testConfigurationFileManagerConfigurationObject_1() throws Exception {
        ...
        file.setPropertyValues("file1", new Object[] { "namespace1",
                "src/test/resources/test_files/accuracy/DBConnectionFactory.xml"});
        ...
        //File fileToCompare = new File("/resources/test_files/accuracy/file/restore1_DBConnectionFactory.xml");
        File fileToCompare = new File(getClass().getClassLoader().getResource("test_files/accuracy/file/restore1_DBConnectionFactory.xml").getFile());
    ...
    public void testConfigurationFileManagerConfigurationObject_2() throws Exception {
        ...
        File fileToCompare = new File("src/test/resources/test_files/accuracy/file/restore2_DBConnectionFactory.xml");
    ...
    public void testConfigurationFileManagerConfigurationObject_3() throws Exception {
        ...
        file.setPropertyValues("file1", new Object[] { namespace,
                "src/test/resources/test_files/accuracy/DBConnectionFactory.xml"});
        file.setPropertyValues("file2", new Object[] { "ns1", "src/test/resources/test_files/accuracy/test6.xml"});
        ...
        File fileToCompare = new File("src/test/resources/test_files/accuracy/file/restore_test6.xml");
    ...
    public void testConfigurationFileManagerMap_1() throws Exception {
        Map map = new HashMap();
        map.put("namespace1", new File("src/test/resources/test_files/accuracy/test1.properties"));
        map.put("namespace2", new File("src/test/resources/test_files/accuracy/test4.properties"));
    ...
    public void testConfigurationFileManagerMap_3() throws Exception {
        Map map = new HashMap();
        map.put("ns", new File("src/test/resources/test_files/accuracy/test7.xml"));
    ...
    public void testConfigurationFileManagerMap_4() throws Exception {
        Map map = new HashMap();
        map.put("ns", new File("src/test/resources/test_files/accuracy/test6.xml"));
        map.put("ns2", new File("src/test/resources/test_files/accuracy/DBConnectionFactory.xml"));
    ...
    public void testConfigurationFileManagerMapMap_2() throws Exception {
        Map map = new HashMap();
        map.put("namespace1", new File("src/test/resources/test_files/accuracy/test1.properties"));
        map.put("namespace2", new File("src/test/resources/test_files/accuracy/test4.xml"));
    ...
    public void testLoadFile_1() throws Exception {
        ...
        manager.loadFile("namespace2", "src/test/resources/test_files/accuracy/test2.xml");
    ...
    public void testLoadFile_2() throws Exception {
        ...
        manager.loadFile("test7", "src/test/resources/test_files/accuracy/test7.properties");
    ...
    public void testCreateFile() throws Exception {
        ...
        manager.createFile("newNamespace", "src/test/resources/test_files/accuracy/file/create.xml", object);
        ...
        ConfigurationObject ret = xmlFilePersistence.loadFile("namespace", new File(
                "src/test/resources/test_files/accuracy/file/create.xml"));
    ...
    public void testRefresh() throws Exception {
        try {
            Map map = new HashMap();
            map.put("namespace1", new File("src/test/resources/test_files/accuracy/test.properties"));
            ...
            persistence.saveFile(new File("src/test/resources/test_files/accuracy/test.properties"), o);
            ...
            FileWriter writer = new FileWriter(new File("src/test/resources/test_files/accuracy/test.properties"));
            writer.write("a=1\n");
            writer.write("a=2\n");
            writer.write("a=3\n");
            writer.write("a=4\n");
    ...
    public void testSaveConfigurationMap() throws Exception {
        try {
            Map map = new HashMap();
            map.put("namespace1", new File("src/test/resources/test_files/accuracy/test_save.properties"));
            ...
            FileWriter writer = new FileWriter(new File("src/test/resources/test_files/accuracy/test_save.properties"));
    ...
    public void testSaveConfigurationStringConfigurationObject_1() throws Exception {
        try {
            Map map = new HashMap();
            map.put("namespace1", new File("src/test/resources/test_files/accuracy/test_save_2_1.properties"));
            ...
            FileWriter writer = new FileWriter(new File("src/test/resources/test_files/accuracy/test_save_2_1.properties"));
            writer.write("a=1000;100;10;1\n");
            writer.close();
        }
    }
    ...
    public void testSaveConfigurationStringConfigurationObject_2() throws Exception {
        try {
            Map map = new HashMap();
            map.put("namespace1", new File("src/test/resources/test_files/accuracy/test_save_2_2.properties"));
            ...
            FileWriter writer = new FileWriter(new File("src/test/resources/test_files/accuracy/test_save_2_2.properties"));
            writer.write("a=1000;100;10;1\n");
            writer.close();
        }
    }
    ...
    public void testSaveConfigurationStringConfigurationObject_3() throws Exception {
        try {
            Map map = new HashMap();
            map.put("namespace1", new File("src/test/resources/test_files/accuracy/test_save_2_3.properties"));
            ...
            FileWriter writer = new FileWriter(new File("src/test/resources/test_files/accuracy/test_save_2_3.properties"));
            writer.write("a=1000;100;10;1\n");
            writer.write("b=1000");
            writer.close();
        }
