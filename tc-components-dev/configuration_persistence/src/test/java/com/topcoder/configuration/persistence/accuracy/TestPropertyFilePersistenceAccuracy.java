...
public class TestPropertyFilePersistenceAccuracy extends TestCase {
    ...
    public void testSaveFile_1() throws Exception {
        File file = new File("src/test/resources/test_files/accuracy/temp.properties");

        if (file.exists()) {
            file.createNewFile();
        }

        ConfigurationObject object = persistence.loadFile("a", new File("src/test/resources/test_files/accuracy/test1.properties"));
    ...
    public void testSaveFile_2() throws Exception {
        ...
        ConfigurationObject object = persistence.loadFile("a", new File("src/test/resources/test_files/accuracy/test2.properties"));
    ...
    public void testSaveFile_3() throws Exception {
        ...
        ConfigurationObject object = persistence.loadFile("a", new File("src/test/resources/test_files/accuracy/test3.properties"));
    ...
    public void testSaveFile_4() throws Exception {
        ...
        ConfigurationObject object = persistence.loadFile("a", new File("src/test/resources/test_files/accuracy/test4.properties"));
    ...
    public void testSaveFile_5() throws Exception {
        ...
        ConfigurationObject object = persistence.loadFile("a", new File("src/test/resources/test_files/accuracy/test5.properties"));
    ...
    public void testSaveFile_6() throws Exception {
        ...
        ConfigurationObject object = persistence.loadFile("a", new File("src/test/resources/test_files/accuracy/test6.properties"));
    ...
    public void testLoadFile_1() throws Exception {
        ...
        File file = new File("src/test/resources/test_files/accuracy/test1.properties");
    ...
    public void testLoadFile_2() throws Exception {
        ...
        File file = new File("src/test/resources/test_files/accuracy/test2.properties");
    ...
    public void testLoadFile_3() throws Exception {
        ...
        File file = new File("src/test/resources/test_files/accuracy/test3.properties");
    ...
    public void testLoadFile_4() throws Exception {
        ...
        File file = new File("src/test/resources/test_files/accuracy/test4.properties");
    ...
    public void testLoadFile_5() throws Exception {
        ...
        File file = new File("src/test/resources/test_files/accuracy/test5.properties");
    ...
    public void testLoadFile_6() throws Exception {
        ...
        File file = new File("src/test/resources/test_files/accuracy/test6.properties");
    ...
    public void testLoadFile_7() throws Exception {
        ...
        File file = new File("src/test/resources/test_files/accuracy/test7.properties");
    ...
    public void testLoadFile_8() throws Exception {
        ...
        File file = new File("src/test/resources/test_files/accuracy/test8.properties");
