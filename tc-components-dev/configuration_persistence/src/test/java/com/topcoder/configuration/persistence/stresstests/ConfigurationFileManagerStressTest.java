...
public class ConfigurationFileManagerStressTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        manager = new ConfigurationFileManager(
                "src/test/resources/test_files/Stress/PreLoad.properties");
    }
    ...
    public void testConfigurationFileManagerString() throws Exception {
        for (int i = 0; i < 10; i++) {
            new ConfigurationFileManager("src/test/resources/test_files/Stress/PreLoad.properties");
        }
    }
    ...
    public void testConfigurationFileManagerMap() throws Exception {
        ...
        map.put("namespace1", new File("src/test/resources/test_files/Stress/Config.xml"));
        map.put("namespace2", new File("src/test/resources/test_files/Stress/Config2.properties"));
        for (int i = 0; i < 10; i++) {
        ...
        try {
            for (int i = 0; i < 10; i++) {
                manager.createFile("namespace_createfile" + i,
                        "src/test/resources/test_files/Stress/tmp/createfile.properties", config);
            }
        } finally {
            StressTestHelper.cleanFolder("src/test/resources/test_files/Stress/tmp");
        }
    }
    ...
    public void testLoadFile() throws Exception {
        for (int i = 0; i < 10; i++) {
            manager.loadFile("namespace_loadfile" + i,
                    "src/test/resources/test_files/Stress/Config.xml");
        }
    }
    ...
    public void testSaveConfiguration() throws Exception {
        ...
        manager.createFile("namespace_savecfg",
                "src/test/resources/test_files/Stress/tmp/saveconfiguration.xml", obj);
