...
public class TestXMLFilePersistenceAccuracy extends TestCase {
    ...
    public void testSaveFile_1() throws Exception {
        File file = new File("src/test/resources/test_files/accuracy/temp.xml");
    ...
    public void testLoadFile_1() throws Exception {
        File file = new File("src/test/resources/test_files/accuracy/DBConnectionFactory.xml");
    ...
    public void testLoadFile_2() throws Exception {
        File file = new File("src/test/resources/test_files/accuracy/test1.xml");
    ...
    public void testLoadFile_3() throws Exception {
        File file = new File("src/test/resources/test_files/accuracy/test2.xml");
    ...
    public void testLoadFile_4() throws Exception {
        File file = new File("src/test/resources/test_files/accuracy/test3.xml");
    ...
    public void testLoadFile_5() throws Exception {
        File file = new File("src/test/resources/test_files/accuracy/test4.xml");
    ...
    public void testLoadFile_6() throws Exception {
        File file = new File("src/test/resources/test_files/accuracy/test5.xml");
    ...
    public void testLoadFile_7() throws Exception {
        File file = new File("src/test/resources/test_files/accuracy/test6.xml");
    ...
    public void testLoadFile_8() throws Exception {
        File file = new File("src/test/resources/test_files/accuracy/test_multiple.xml");
