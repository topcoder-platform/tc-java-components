...
public class Demo extends TestCase {
    ...
    public void testDemo() throws Exception {
        ConfigurationFileManager manager = new ConfigurationFileManager("src/test/resources/test_files/demopreload.properties");
        ...
        manager.loadFile(newNamespace, "src/test/resources/test_files/test.properties");
