...
public class ConfigurationFileManagerFailureTests extends TestCase {
     ...
     * </p>
     */
    private static final String tmpFile = "src/test/resources/test_files/failuretests/temp.xml";
    ...
    protected void setUp() throws Exception {
        ...
        if (configurationFileManager == null) {
            configurationFileManager = new ConfigurationFileManager("src/test/resources/test_files/failuretests/load.properties");
        }
    }
    ...
    public void testConfigurationFileManager_String_ConfigurationParserException()
        throws Exception {
        try {
            new ConfigurationFileManager("src/test/resources/test_files/failuretests/parser_error.properties");
    ...
    public void testConfigurationFileManager_String_NamespaceConflictException()
        throws Exception {
        try {
            new ConfigurationFileManager("src/test/resources/test_files/failuretests/namespace_conflict.properties");
    ...
    public void testConfigurationFileManager_String_UnrecognizedFileTypeException()
        throws Exception {
        try {
            new ConfigurationFileManager("src/test/resources/test_files/failuretests/UnrecognizedFileType.urf");
    ...
    public void testConfigurationFileManager_StringMap_ConfigurationParserException()
        throws Exception {
        try {
            new ConfigurationFileManager("src/test/resources/test_files/failuretests/parser_error.properties", persistenceMap);
            fail("Test failure for ConfigurationFileManager() failed, ConfigurationParserException expected.");
        } catch (ConfigurationParserException e) {
            // Success
        }
    ...
    public void testConfigurationFileManager_StringMap_NamespaceConflictException()
        throws Exception {
        try {
            new ConfigurationFileManager("src/test/resources/test_files/failuretests/namespace_conflict.properties", persistenceMap);
            fail("Test failure for ConfigurationFileManager() failed, NamespaceConflictException expected.");
        } catch (NamespaceConflictException e) {
            // Success
        }
    ...
    public void testConfigurationFileManager_StringMap_UnrecognizedFileTypeException()
        throws Exception {
        try {
            new ConfigurationFileManager("src/test/resources/test_files/failuretests/UnrecognizedFileType.urf", persistenceMap);
            fail("Test failure for ConfigurationFileManager() failed, UnrecognizedFileTypeException expected.");
        } catch (UnrecognizedFileTypeException e) {
            // Success
        }
    ...
    public void testConfigurationFileManager_StringMap_Null2()
        throws Exception {
        try {
            new ConfigurationFileManager("src/test/resources/test_files/failuretests/demo_config.xml", null);
            fail("Test failure for ConfigurationFileManager() failed, IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
    ...
    public void testConfigurationFileManager_ConfigurationObject_IOException()
        ...
        try {
            fileConfig.setPropertyValues("file1",
                new Object[] {
                    "com.topcoder.configuration.persistence", "src/test/resources/test_files/failuretests/not_exist_file.properties"
                });
    ...
    public void testConfigurationFileManager_ConfigurationObject_ConfigurationParserException()
        ...
        try {
            fileConfig.setPropertyValues("config",
                new String[] {"com.topcoder.configuration.persistence", "src/test/resources/test_files/failuretests/parser_error.properties"});
            new ConfigurationFileManager(configurationObject);
            fail("Test failure for ConfigurationFileManager() failed, ConfigurationParserException expected.");
        } catch (ConfigurationParserException e) {
            // Success
    ...
    public void testConfigurationFileManager_ConfigurationObject_UnrecognizedFileTypeException()
        ...
        try {
            fileConfig.setPropertyValues("config",
                new String[] {
                    "com.topcoder.configuration.persistence", "src/test/resources/test_files/failuretests/UnrecognizedFileType.urf"
                });
            new ConfigurationFileManager(configurationObject);
            fail("Test failure for ConfigurationFileManager() failed, UnrecognizedFileTypeException expected.");
        } catch (UnrecognizedFileTypeException e) {
    ...
    public void testConfigurationFileManager_Map_IOException()
        throws Exception {
        File file = new File("src/test/resources/test_files/failuretests/no_existed_files.xml");
    ...
    public void testConfigurationFileManager_Map_ConfigurationParserException()
        throws Exception {
        try {
            filesMap.put("com.topcoder.configuration.persistence", new File("src/test/resources/test_files/failuretests/parser_error.xml"));
            new ConfigurationFileManager(filesMap);
            fail("Test failure for ConfigurationFileManager() failed, ConfigurationParserException expected.");
        } catch (ConfigurationParserException e) {
            // Success
    ...
    public void testConfigurationFileManager_Map_UnrecognizedFileTypeException()
        ...
        try {
            filesMap.put("com.topcoder.configuration.persistence",
                new File("src/test/resources/test_files/failuretests/UnrecognizedFileType.urf"));
            new ConfigurationFileManager(filesMap);
            fail("Test failure for ConfigurationFileManager() failed, UnrecognizedFileTypeException expected.");
        } catch (UnrecognizedFileTypeException e) {
            // Success
    ...
    public void testConfigurationFileManager_Map_EmptyKey()
        throws Exception {
        try {
            filesMap.put("   ", new File("src/test/resources/test_files/failuretests/demo_config.xml"));
            new ConfigurationFileManager(filesMap);
            fail("Test failure for ConfigurationFileManager() failed, IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            // Success
    ...
    public void testConfigurationFileManager_Map_NotStringKey()
        throws Exception {
        try {
            filesMap.put(new Object(), new File("src/test/resources/test_files/failuretests/demo_config.xml"));
            new ConfigurationFileManager(filesMap);
            fail("Test failure for ConfigurationFileManager() failed, IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            // Success
    ...
    public void testConfigurationFileManager_Map_NotFileValue()
        throws Exception {
        try {
            filesMap.put("   ", "src/test/resources/test_files/failuretests/demo_config.xml");
            new ConfigurationFileManager(filesMap);
            fail("Test failure for ConfigurationFileManager() failed, IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            // Success
    ...
    public void testLoadFile_StringString_ConfigurationParserException()
        throws Exception {
        try {
            configurationFileManager.loadFile("namespace", "src/test/resources/test_files/failuretests/parser_error.properties");
    ...
    public void testLoadFile_StringString_UnrecognizedFileTypeException()
        throws Exception {
        try {
            configurationFileManager.loadFile("namespace", "src/test/resources/test_files/failuretests/UnrecognizedFileType.urf");
    ...
    public void testLoadFile_StringString_NamespaceConflictException()
        throws Exception {
        try {
            configurationFileManager.loadFile(NAMESPACE, "src/test/resources/test_files/failuretests/config1.xml");
    ...
    public void testLoadFile_StringString_Null1() throws Exception {
        try {
            configurationFileManager.loadFile(null, "src/test/resources/test_files/failuretests/demo_config.xml");
    ...
    public void testLoadFile_StringString_Empty1() throws Exception {
        try {
            configurationFileManager.loadFile("     ", "src/test/resources/test_files/failuretests/demo_config.xml");
            fail("Test failure for loadFile() failed, IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
    ...
    public void testSaveConfiguration_Map_InvalidConfigurationUpdateException()
        ...
        fileConfig.setPropertyValues("config", new Object[] {NAMESPACE, "src/test/resources/test_files/failuretests/no_existed_files.xml"});
