...
public class PropertyFilePersistenceFailureTests extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        testFile = new File("src/test/resources/test_files/failuretests/config1.xml");
        tempFile = new File("src/test/resources/test_files/failuretests/temp.xml");
    }
    ...
    public void testLoadFile_StringFile_IOException() throws Exception {
        try {
            propertyFilePersistence.loadFile(NAMESPACE, new File("src/test/resources/test_files/failuretests/not_existed_files.properties"));
    ...
    public void testLoadFile_StringFile_ConfigurationParserException() throws Exception {
        try {
            propertyFilePersistence.loadFile(NAMESPACE, new File("src/test/resources/test_files/failuretests/parser_error.properties"));
